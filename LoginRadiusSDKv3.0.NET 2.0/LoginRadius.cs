...
namespace LoginRadiusSDK {
    ...
    public class LoginRadius {
        ...
        /// <summary>
        /// If IsAuthenticate ID returns true then user successfully logged in and data can be fetched
        /// </summary>
        ...
        public LoginRadius(string apiSecret) {
            ...
            if (Utility.IsGuid(apiSecret)) {
                ...
                throw new Exception("Invalid LoginRadius API key, Please verify it from your LoginRadius.com account.");
            }
        }
