...
namespace LoginRadiusSDK.V2.Api
{
    public class AccountEntity : LoginRadiusResource
    {
        ...
        public ApiResponse<LoginResponse> LoginByBackupCode(
        ...
        public ApiResponse<LoginRadiusUserIdentity> TwoFAbyGoogleAuthCodeOROTPbyToken( string  access_token, string googleauthenticatorcode="", string otp="", string smstemplate2fa= "")
        {
            Validate(new ArrayList { access_token });
