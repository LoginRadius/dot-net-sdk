...
namespace LoginRadiusSDK.V2.Entity
{
    ...
    {
        public static string GetSott(Sott sottAuth)
        {
            string secret = LoginRadiusResource.ConfigDictionary[BaseConstants.LoginRadiusApiSecret];
            string key = LoginRadiusResource.ConfigDictionary[BaseConstants.LoginRadiusApiKey];
