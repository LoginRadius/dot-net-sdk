...
namespace LoginRadius.Sdk.Internal.OpenApi.Model
{
    ...
    public class EmailJsonConverter : JsonConverter<Email>
    {
        ...
        public override Email Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!type.IsSet)
                throw new ArgumentException("Property is required for class Email.", nameof(type));

            if (!value.IsSet)
                throw new ArgumentException("Property is required for class Email.", nameof(value));

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class Email.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class Email.");

            return new Email(type.Value!, value.Value!);
        }
        ...
        {
            if (email.Type == null)
                throw new ArgumentNullException(nameof(email.Type), "Property is required for class Email.");

            if (email.Value == null)
                throw new ArgumentNullException(nameof(email.Value), "Property is required for class Email.");

            writer.WriteString("Type", email.Type);
