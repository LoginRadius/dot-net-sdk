...
namespace LoginRadius.Sdk.Internal.OpenApi.Model
{
    ...
    public partial class Role : IValidatableObject
    {
        ...
        /// <param name="originalName">Original (unnormalized) Role Name</param>
        /// <param name="permissions">permissions</param>
        /// <param name="createdDate">Role Created Date</param>
        /// <param name="modifiedDate">Role Modified Date</param>
        [JsonConstructor]
        public Role(Option<string?> id = default, Option<string?> name = default, Option<string?> description = default, Option<string?> level = default, Option<string?> orgId = default, Option<string?> originalName = default, Option<List<Permission>?> permissions = default, Option<DateTime?> createdDate = default, Option<DateTime?> modifiedDate = default)
        {
            IdOption = id;
            NameOption = name;
        ...
        /// </summary>
        /// <value>Original (unnormalized) Role Name</value>
        /* <example>Admin</example> */
    ...
    public class RoleJsonConverter : JsonConverter<Role>
    {
        ...
        public override Role Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (orgId.IsSet && orgId.Value == null)
                throw new ArgumentNullException(nameof(orgId), "Property is not nullable for class Role.");

            if (originalName.IsSet && originalName.Value == null)
                throw new ArgumentNullException(nameof(originalName), "Property is not nullable for class Role.");
            ...
            if (createdDate.IsSet && createdDate.Value == null)
                throw new ArgumentNullException(nameof(createdDate), "Property is not nullable for class Role.");

            if (modifiedDate.IsSet && modifiedDate.Value == null)
                throw new ArgumentNullException(nameof(modifiedDate), "Property is not nullable for class Role.");

            return new Role(id, name, description, level, orgId, originalName, permissions, createdDate, modifiedDate);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Role role, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (role.LevelOption.IsSet && role.Level == null)
                throw new ArgumentNullException(nameof(role.Level), "Property is required for class Role.");

            if (role.OrgIdOption.IsSet && role.OrgId == null)
                throw new ArgumentNullException(nameof(role.OrgId), "Property is required for class Role.");

            if (role.OriginalNameOption.IsSet && role.OriginalName == null)
                throw new ArgumentNullException(nameof(role.OriginalName), "Property is required for class Role.");
            ...
            if (role.LevelOption.IsSet)
                writer.WriteString("Level", role.Level);

            if (role.OrgIdOption.IsSet)
                writer.WriteString("OrgId", role.OrgId);

            if (role.OriginalNameOption.IsSet)
                writer.WriteString("OriginalName", role.OriginalName);
            ...
            if (role.CreatedDateOption.IsSet)
                writer.WriteString("CreatedDate", role.CreatedDateOption.Value!.Value.ToString(CreatedDateFormat));

            if (role.ModifiedDateOption.IsSet)
                writer.WriteString("ModifiedDate", role.ModifiedDateOption.Value!.Value.ToString(ModifiedDateFormat));
        }
    }
}
